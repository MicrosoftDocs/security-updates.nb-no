---
title: Microsoft Security Bulletin MS08-054 - Critical
TOCTitle: MS08-054
ms:assetid: ms08-054
ms:mtpsurl: https://technet.microsoft.com/nb-NO/library/ms08-054(v=Security.10)
ms:contentKeyID: 61231083
ms.date: 04/18/2014
...
## Sikkerhetsproblem i Windows Media Player som kan føre til ekstern kjøring av kode (954154)
...
Denne sikkerhetsoppdateringen har alvorlighetsgraden Kritisk for alle støttede og berørte versjoner av Windows Media Player 11. Hvis du vil ha mer informasjon, kan du se avsnittet **Berørt og uberørt programvare** i denne delen.

Sikkerhetsoppdateringen retter opp sikkerhetsproblemet ved å korrigere måten Windows Media Player 11 håndterer direkteavspilte lydfiler på fra en SSPL (Server-Side Playlist). Hvis du vil ha mer informasjon om sikkerhetsproblemet, kan du se avsnittet Vanlige spørsmål for den bestemte sikkerhetsproblemoppføringen under neste del, **Informasjon om sikkerhetsproblemer**.
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=d5891180-5dd1-49ec-bcc6-3030a544202c">Windows Media Player 11</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=caf8a45e-a9f8-4e91-98fd-87eddbeae64c">Windows Media Player 11</a></td>
<td style="border:1px solid black;">Ekstern kjøring av kode</td>
<td style="border:1px solid black;">Kritisk</td>
<td style="border:1px solid black;">Ingen</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2f4118fd-1ffb-46da-b922-cd4ca4f9d84e">Windows Media Player 11</a></td>
<td style="border:1px solid black;">Ekstern kjøring av kode</td>
<td style="border:1px solid black;">Kritisk</td>
<td style="border:1px solid black;">Ingen</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=334352e7-d41f-494f-866d-f1f1745ffd17">Windows Media Player 11</a></td>
<td style="border:1px solid black;">Ekstern kjøring av kode</td>
<td style="border:1px solid black;">Kritisk</td>
<td style="border:1px solid black;">Ingen</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=72fc6028-6af4-44ec-8d2a-28c53807d6bc">Windows Media Player 11</a></td>
<td style="border:1px solid black;">Ekstern kjøring av kode</td>
<td style="border:1px solid black;">Kritisk</td>
<td style="border:1px solid black;">Ingen</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=3906512b-26db-473e-b522-3883ff34a21c">Windows Media Player 11</a></td>
<td style="border:1px solid black;">Ekstern kjøring av kode</td>
<td style="border:1px solid black;">Kritisk</td>
<td style="border:1px solid black;">Ingen</td>
</tr>
...
Microsoft reviderte denne bulletinen for å informere om nypubliseringen av den norskspråklige oppdateringen for Windows Media Player 11 på alle støttede 32-biters versjoner av Windows XP for å løse et kvalitetsproblem som ville føre til at oppdateringen ikke ville la seg installere. Kunder som har lastet ned og forsøkt å installere den norskspråklige oppdateringen, må laste ned og installere den nypubliserte oppdateringen for å være beskyttet mot sikkerhetsproblemet som beskrives i denne bulletinen. Ingen andre oppdateringer eller områder er påvirket av denne nypubliseringen. Microsoft fjernet også en feilreferanse til Windows Media Player 10 som en komponent i Windows Vista x64 Edition og Windows Vista x64 Edition Service Pack 1 fra tabellen over uberørt programvare, ettersom dette ikke er en støttet konfigurasjon.

**Hvor finner jeg filinformasjonsdetaljene?**    
Filinformasjonsdetaljene finner du i [Microsoft Knowledge Base-artikkel-954154](http://support.microsoft.com/kb/954154).
...
<th style="border:1px solid black;">Sikkerhetsproblem med samplingsfrekvensen i Windows Media Player – CVE-2008-2253</th>
<th style="border:1px solid black;">Samlet alvorlighetsgrad</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Windows Media Player 11 på Windows XP Service Pack 2 og Windows XP Service Pack 3</td>
<td style="border:1px solid black;"><strong>Kritisk</strong><br />
Ekstern kjøring av kode</td>
<td style="border:1px solid black;"><strong>Kritisk</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Media Player 11 på Windows XP Professional x64 Edition og Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Kritisk</strong><br />
Ekstern kjøring av kode</td>
<td style="border:1px solid black;"><strong>Kritisk</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Media Player 11 på Windows Vista og Windows Vista Service Pack 1</td>
<td style="border:1px solid black;"><strong>Kritisk</strong><br />
Ekstern kjøring av kode</td>
<td style="border:1px solid black;"><strong>Kritisk</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Media Player 11 på Windows Vista x64 Edition og Windows Vista x64 Edition Service Pack 1</td>
<td style="border:1px solid black;"><strong>Kritisk</strong><br />
Ekstern kjøring av kode</td>
<td style="border:1px solid black;"><strong>Kritisk</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Media Player 11 på Windows Server 2008 for 32-biters systemer*</td>
<td style="border:1px solid black;"><strong>Kritisk</strong><br />
Ekstern kjøring av kode</td>
<td style="border:1px solid black;"><strong>Kritisk</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Media Player 11 på Windows Server 2008 for x64-baserte systemer*</td>
<td style="border:1px solid black;"><strong>Kritisk</strong><br />
Ekstern kjøring av kode</td>
<td style="border:1px solid black;"><strong>Kritisk</strong></td>
</tr>
...
## Sikkerhetsproblem med samplingsfrekvensen i Windows Media Player – CVE-2008-2253

Det finnes et sikkerhetsproblem i Windows Media Player 11 som kan føre til ekstern kjøring av kode. En angriper kan utnytte dette sikkerhetsproblemet ved å opprette en spesiallaget lydfil som kan tillate ekstern kjøring av kode, når en spesiallaget lydfil direkteavspilles fra en Windows Media-server ved hjelp av Windows Media Player 11. En angriper som klarer å utnytte dette sikkerhetsproblemet, kan få full kontroll over et berørt system.

Hvis du vil se dette sikkerhetsproblemet som en standardoppføring i listen Common Vulnerabilities and Exposures, kan du se [CVE-2008-2253](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2253).

#### Begrensende faktorer for sikkerhetsproblemet med samplingsfrekvensen i Windows Media Player – CVE-2008-2253
...
#### Midlertidige løsninger for sikkerhetsproblemet med samplingsfrekvensen i Windows Media Player – CVE-2008-2253

Midlertidige løsninger viser til en innstilling eller konfigurasjonsendring som ikke løser det underliggende sikkerhetsproblemet, men hjelper til med å blokkere kjente angrepsvektorer før du installerer oppdateringen. Microsoft har testet følgende midlertidige løsninger og informerer i diskusjonen om en midlertidig løsning reduserer funksjonaliteten:

  - **Avregistrere wmpeffects.dll**  
    Hvis du vil avregistrere denne DLL-filen, kjører du følgende kommando fra hevet ledetekst:
      - **For 32-biters Windows-baserte systemer:**  
        Regsvr32.exe –u %WINDIR%\\system32\\wmpeffects.dll
      - **For 64-biters Windows-baserte systemer:**  
        Regsvr32.exe –u %WINDIR%\\syswow64\\wmpeffects.dll
      - **Hva løsningen kan føre til:** Visualiseringer vises ikke i Avspilling-visningen i Windows Media Player.
...
#### Vanlige spørsmål om sikkerhetsproblemet med samplingsfrekvensen i Windows Media Player – CVE-2008-2253

**Hva er omfanget av sikkerhetsproblemet?**    
Dette er et sikkerhetsproblem som kan forårsake ekstern kjøring av kode. Hvis en bruker er logget på med administrative rettigheter, kan en angriper som klarte å utnytte dette sikkerhetsproblemet, ta kontroll over det berørte systemet. En angriper kan deretter installere programmer, vise, endre eller slette data, eller opprette nye kontoer med fullstendige brukerrettigheter. Brukere med kontoer som er konfigurert med få brukerrettigheter på systemet, er mindre utsatt enn brukere som har administrative rettigheter.

**Hva forårsaker sikkerhetsproblemet?**    
Windows Media Player 11 håndterer spesiallagde direkteavspilte lydfiler fra en Windows Media-server feilaktig i en SSPL (Server-Side Playlist).

**Hva er SSPL (Server-Side Playlist)?**    
SSPL er en liste som identifiserer innholdet som spilles for en klient, tidspunktet for avspillingen og avspillingsrekkefølgen. SSPL for en Windows Media-server er et XML-dokument. Hvis du vil ha mer informasjon om SSPL, kan du se [Server-Side Playlists](http://msdn.microsoft.com/en-us/library/ms753585\(vs.85\).aspx).
...
Dette sikkerhetsproblemet krever at en bruker åpner en spesiallaget lydfil fra en Windows Media-server.

I et webbasert angrepsscenario må angriperen være vert for en Windows Media-server som inneholder en spesiallaget lydfil som brukes til å prøve å utnytte dette sikkerhetsproblemet. En angriper kan ikke tvinge brukere til å besøke et spesiallaget webområde. I stedet må angriperen lokke brukere til å besøke webområdet, vanligvis ved å få dem til å klikke en kobling i en e-postmelding eller direktemelding som fører dem til angriperens område.

**Hvilke systemer er hovedsakelig i faresonen på grunn av sikkerhetsproblemet?**    
Alle systemer som bruker Windows Media Player, for eksempel arbeidsstasjoner eller terminalservere, er utsatt overfor dette sikkerhetsproblemet.

**Hva gjør oppdateringen?**    
Sikkerhetsoppdateringen retter opp sikkerhetsproblemet ved å korrigere måten Windows Media Player 11 håndterer direkteavspilte lydfiler fra en SSPL på.
...
<td style="border:1px solid black;">For Windows Media Player 11 på alle støttede 32-biters versjoner av Windows XP:<br />
WindowsMedia11-KB954154-X86-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For Windows Media Player 11 på alle støttede 64-biters versjoner av Windows XP:<br />
...
<td style="border:1px solid black;">Bruk verktøyet Legg til eller fjern programmer i Kontrollpanel eller Spuninst.exe-verktøyet som ligger i mappen %Windir%\\$NTUninstallKB954154_WM11$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Filinformasjon</strong></td>
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/954154">Microsoft Knowledge Base-artikkel 954154</a></td>
</tr>
<tr class="even">
...
<br />
For Windows Media Player 11 på alle støttede 64-biters versjoner av Windows XP:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Installasjon uten brukermedvirkning</td>
<td style="border:1px solid black;">For alle støttede 32-biters versjoner av Windows Server 2008 med skrivebordsopplevelse:<br />
Windows6.0-KB954154-x86 /quiet<br />
<br />
For alle støttede x64-biters versjoner av Windows Server 2008 med skrivebordsopplevelse:<br />
Windows6.0-KB954154-x64 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Installasjon uten å starte på nytt</td>
...
<tr class="odd">
<td style="border:1px solid black;">Mer informasjon</td>
<td style="border:1px solid black;">Hvis du vil ha mer informasjon om skrivebordsopplevelse i Windows Server 2008, kan du se TechNet-artikkelen &quot;Windows Mail, Windows Media Player, and Other Features in the Desktop Experience in Windows Server 2008&quot;.<br />
<br />
Hvis du vil ha mer informasjon om hvordan du distribuerer denne oppdateringen, kan du se avsnittet <strong>Veiledning og verktøy for søking og distribusjon.</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Krav om omstart</strong></td>
<td style="border:1px solid black;"></td>
...
#### Revisjoner
  ...
  - V1.1 (10. september 2008): Feilaktig oppføring fjernet fra **Begrensende faktorer for sikkerhetsproblemet med samplingsfrekvensen i Windows Media Player – CVE-2008-2253**.
  - V2.0 (15. september 2008): Det er lagt til en oppføring i delen **Vanlige spørsmål som er relatert til denne sikkerhetsoppdateringen** for å informere om nypubliseringen av den norskspråklige oppdateringen for Windows Media Player 11 på alle støttede 32-biters versjoner av Windows XP. Kunder som trenger norskspråklige oppdateringer, må laste ned og installere oppdateringene på nytt. Det er også fjernet en feiloppføring fra tabellen over uberørt programvare.
