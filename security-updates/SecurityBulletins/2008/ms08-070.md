...
## Alvorlighetsgrader og identifikatorer for sikkerhetsproblem
 ...
 <table style="border:1px solid black;" class="dataTable">
          ...
          <tr class="thead"><th style="border:1px solid black;">Berørt programvare</th><th style="border:1px solid black;">Sikkerhetsproblem i DataGrid-kontrollen som kan føre til minnefeil – CVE-2008-4252</th><th style="border:1px solid black;">Sikkerhetsproblem i FlexGrid-kontrollen som kan føre til minnefeil – CVE-2008-4253</th><th style="border:1px solid black;">Sikkerhetsproblem i FlexGrid-kontrollen som kan føre til hierarkisk minnefeil – CVE-2008-4254</th><th style="border:1px solid black;">Sikkerhetsproblem med overflyt ved analyse av felles AVI-filer i Windows – CVE-2008-4255</th><th style="border:1px solid black;">Sikkerhetsproblem i Charts-kontroll som kan føre til minnefeil – CVE-2008-4256</th><th style="border:1px solid black;">Sikkerhetsproblem i Masked Edit-kontrollen som kan føre til minnefeil – CVE-2008-3704</th><th style="border:1px solid black;">Samlet alvorlighetsgrad</th></tr>
            ...
            <tr><th colspan="8" style="border:1px solid black;">Utviklerverktøy fra Microsoft</th></tr>
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Visual Basic 6.0 Runtime Extended Files</td>
<td style="border:1px solid black;">Nei</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Visual Studio .NET 2002 Service Pack 1</td>
<td style="border:1px solid black;">Nei</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Visual FoxPro 8.0 Service Pack 1</td>
<td style="border:1px solid black;">Nei</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Visual FoxPro 9.0 Service Pack 1</td>
<td style="border:1px solid black;">Nei</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Visual FoxPro 9.0 Service Pack 2</td>
<td style="border:1px solid black;">Nei</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office FrontPage 2002 Service Pack 3</td>
<td style="border:1px solid black;">Ja</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Office Project 2003 Service Pack 3</td>
<td style="border:1px solid black;">Ja</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office Project 2007</td>
<td style="border:1px solid black;">Ja</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Office Project 2007 Service Pack 1</td>
<td style="border:1px solid black;">Ja</td>
</tr>
</tbody>
</table>
...
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/932349">Microsoft Knowledge Base-artikkel 932349</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Start datamaskinen på nytt etter installasjon hvis nødvendig (for eksempel hvis en fil er låst eller i bruk)</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;">Mer informasjon</td>
<td style="border:1px solid black;">Hvis du vil ha mer informasjon om oppdaging og distribusjon, kan du se delen <strong>Microsofts veiledning og verktøy for søking og distribusjon</strong> tidligere i denne bulletinen.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Krav om omstart</strong></td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Installasjon uten brukermedvirkning</td>
<td style="border:1px solid black;">For forenklet kinesisk (Kina):<br />
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">FrontPage 2002 SP3</td>
<td style="border:1px solid black;">FPClientNonBootFiles, ProductNonBootFiles</td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td style="border:1px solid black;">Installasjon uten brukermedvirkning</td>
<td style="border:1px solid black;">For Microsoft Office Project 2003 Service Pack 3:<br />
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Project 2003 SP3</td>
<td style="border:1px solid black;">PROJECTFiles</td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td style="border:1px solid black;">Installasjon uten brukermedvirkning</td>
<td style="border:1px solid black;">For Microsoft Office Project 2007:<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Filinformasjon</strong></td>
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/9323493">Microsoft Knowledge Base-artikkel 932349</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kontroll av registernøkkel</strong></td>
<td style="border:1px solid black;">Ikke relevant</td>
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Project 2007</td>
<td style="border:1px solid black;">PROJECTFiles</td>
</tr>
</tbody>
</table>
