---
title: Microsoft Security Bulletin MS08-058 - Critical
TOCTitle: MS08-058
ms:assetid: ms08-058
ms:mtpsurl: https://technet.microsoft.com/nb-NO/library/ms08-058(v=Security.10)
ms:contentKeyID: 61231087
ms.date: 04/18/2014
...
## Kumulativ sikkerhetsoppdatering for Internet Explorer (956390)
...
Denne sikkerhetsoppdateringen har alvorlighetsgraden Kritisk for Internet Explorer 5.01 og Internet Explorer 6 Service Pack 1 som kjører på alle støttede versjoner av Microsoft Windows 2000, og for Internet Explorer 6 som kjører på alle støttede versjoner av Windows XP. For Internet Explorer 7 som kjører på alle støttede versjoner av Windows XP og Windows Vista, har denne sikkerhetsoppdateringen alvorlighetsgraden Viktig. Ellers har denne sikkerhetsoppdateringen alvorlighetsgraden Moderat eller Lav. Hvis du vil ha mer informasjon, kan du se avsnittet **Berørt og uberørt programvare** i denne delen.
  ...
  <tr class="thead">
    ...
    <th style="border:1px solid black;">Bulletiner som erstattes av denne oppdateringen </th>
          ...
          <tr><td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4</td><td style="border:1px solid black;">
              ...
              <a Target="" runat="server" href="http://go.microsoft.com/fwlink/?linkid=122772">MS08-045</a>
            </td></tr>
          <tr class="alternateRow"><td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4 </td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://www.microsoft.com/downloads/details.aspx?familyid=02390258-08e9-4b75-960d-be081b749558">Microsoft Internet Explorer 6 Service Pack 1</a>
            </td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Kritisk</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://go.microsoft.com/fwlink/?linkid=122772">MS08-045</a>
            </td></tr>
          ...
          <tr><td style="border:1px solid black;">Windows Server 2003 Service Pack 1 og Windows Server 2003 Service Pack 2</td><td style="border:1px solid black;">
            ...
            </td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Moderat</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://go.microsoft.com/fwlink/?linkid=122772">MS08-045</a>
            </td></tr>
          ...
          <tr class="alternateRow"><td style="border:1px solid black;">Windows XP Service Pack 2 og Windows XP Service Pack 3</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://www.microsoft.com/downloads/details.aspx?familyid=4e73de2b-05e6-4901-9bac-46d8f469e635">Windows Internet Explorer 7</a>
            </td><td style="border:1px solid black;">Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">Viktig</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://go.microsoft.com/fwlink/?linkid=122772">MS08-045</a>
            </td></tr>
          <tr><td style="border:1px solid black;">Windows XP Professional x64 Edition og Windows XP Professional x64 Edition Service Pack 2</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://www.microsoft.com/downloads/details.aspx?familyid=ccf7a3e3-ec30-4b95-9a86-00032301513c">Windows Internet Explorer 7</a>
            </td><td style="border:1px solid black;">Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">Viktig</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://go.microsoft.com/fwlink/?linkid=122772">MS08-045</a>
            </td></tr>
          <tr class="alternateRow"><td style="border:1px solid black;">Windows Server 2003 Service Pack 1 og Windows Server 2003 Service Pack 2</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://www.microsoft.com/downloads/details.aspx?familyid=feaf2adf-7892-4dbf-a147-db4d5dbe52f3">Windows Internet Explorer 7</a>
            </td><td style="border:1px solid black;">Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">Lav</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://go.microsoft.com/fwlink/?linkid=122772">MS08-045</a>
            </td></tr>
          <tr><td style="border:1px solid black;">Windows Server 2003 x64 Edition og Windows Server 2003 x64 Edition Service Pack 2</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://www.microsoft.com/downloads/details.aspx?familyid=319dba34-07ca-47f9-a1e9-20df2df7966b">Windows Internet Explorer 7</a>
            </td><td style="border:1px solid black;">Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">Lav</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://go.microsoft.com/fwlink/?linkid=122772">MS08-045</a>
            </td></tr>
          <tr class="alternateRow"><td style="border:1px solid black;">Windows Server 2003 SP1 for Itanium-based Systems og Windows Server 2003 SP2 for Itanium-based Systems</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://www.microsoft.com/downloads/details.aspx?familyid=47381d91-4a14-4a09-96b3-3345155df52d">Windows Internet Explorer 7</a>
            </td><td style="border:1px solid black;">Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">Lav</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://go.microsoft.com/fwlink/?linkid=122772">MS08-045</a>
            </td></tr>
          ...
          <tr><td style="border:1px solid black;">Windows Server 2008 for 32-biters systemer*</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://www.microsoft.com/downloads/details.aspx?familyid=ec73f416-2204-42d6-8932-c96578ac819f">Windows Internet Explorer 7</a>
            </td><td style="border:1px solid black;">Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">Lav</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://go.microsoft.com/fwlink/?linkid=122772">MS08-045</a>
            </td></tr>
          <tr class="alternateRow"><td style="border:1px solid black;">Windows Server 2008 for x64-baserte systemer*</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://www.microsoft.com/downloads/details.aspx?familyid=baacd1c2-9764-4fea-bd4d-c49791974fef">Windows Internet Explorer 7</a>
            </td><td style="border:1px solid black;">Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">Lav</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://go.microsoft.com/fwlink/?linkid=122772">MS08-045</a>
            </td></tr>
...
Filinformasjonsdetaljene finner du i [Microsoft Knowledge Base-artikkel 956390](http://support.microsoft.com/kb/956390).
...
<th style="border:1px solid black;">Sikkerhetsproblem med egenskap for vindusplassering på tvers av domener – CVE-2008-2947</th>
<th style="border:1px solid black;">Sikkerhetsproblem med HTML-element på tvers av domener – CVE-2008-3472</th>
<th style="border:1px solid black;">Sikkerhetsproblem med hendelseshåndtering på tvers av domener – CVE-2008-3473</th>
<th style="border:1px solid black;">Sikkerhetsproblem som kan føre til tilgjengeliggjøring av informasjon på tvers av domener – CVE-2008-3474</th>
<th style="border:1px solid black;">Sikkerhetsproblem med feil i ikke-initialisert minne - CVE-2008-3475</th>
<th style="border:1px solid black;">Sikkerhetsproblem med HTML-objekter som kan føre til minnefeil – CVE-2008-3476</th>
<th style="border:1px solid black;">Samlet alvorlighetsgrad</th>
</tr>
</thead>
<tbody>
...
<td style="border:1px solid black;"><strong>Lav</strong> <br />
Tilgjengeliggjøring av informasjon</td>
<td style="border:1px solid black;"><strong>Lav</strong> <br />
Tilgjengeliggjøring av informasjon</td>
<td style="border:1px solid black;"><strong>Lav</strong> <br />
...
<td style="border:1px solid black;">Ikke relevant</td>
<td style="border:1px solid black;">Ikke relevant</td>
<td style="border:1px solid black;"><strong>Lav</strong></td>
</tr>
<tr class="odd">
...
## Sikkerhetsproblem med egenskap for vindusplassering på tvers av domener – CVE-2008-2947

Det finnes et sikkerhetsproblem i Internet Explorer som kan føre til ekstern kjøring av kode eller tilgjengeliggjøring av informasjon, og som kan gjøre det mulig for en angriper å få tilgang til et webleservindu i et annet domene eller en annen Internet Explorer-sone. En angriper kan utnytte sikkerhetsproblemet ved å opprette en spesiallaget webside som kan tillate ekstern kjøring av kode eller tilgjengeliggjøring av informasjon, avhengig av operativsystemet, hvis en bruker viser websiden.

Hvis du vil se dette sikkerhetsproblemet som en standardoppføring i listen Common Vulnerabilities and Exposures, kan du se [CVE-2008-2947](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2947).

#### Begrensende faktorer for sikkerhetsproblemet med egenskap for vindusplassering på tvers av domener – CVE-2008-2947
...
#### Midlertidige løsninger for sikkerhetsproblemet med egenskap for vindusplassering på tvers av domener – CVE-2008-2947
...
#### Vanlige spørsmål om sikkerhetsproblemet med egenskap for vindusplassering på tvers av domener – CVE-2008-2947

**Hva er omfanget av sikkerhetsproblemet?**  
Dette er et sikkerhetsproblem som kan føre til ekstern kjøring av kode for Internet Explorer 5.01 Service Pack 4 eller Internet Explorer 6 Service Pack 1 som kjører på Microsoft Windows 2000 Service Pack 4. En angriper som utnytter dette sikkerhetsproblemet, kan få samme brukerrettigheter som den påloggede brukeren.
...
Dette er et sikkerhetsproblem som kan føre til tilgjengeliggjøring av informasjon for Internet Explorer 6 eller Internet Explorer 7 som kjører på støttede versjoner og utgaver av Windows XP, Windows Server 2003, Windows Vista og Windows Server 2008. En angriper som utnytter dette sikkerhetsproblemet, kan lese informasjonskapsler eller andre data fra et annet Internet Explorer-domene. Brukermedvirkning er imidlertid nødvendig for å utnytte sikkerhetsproblemet.

**Hva forårsaker sikkerhetsproblemet?**    
Internet Explorer feiltolker opprinnelsen til skript og tillater at det kjøres i konteksten til et annet domene eller en annen Internet Explorer-sikkerhetssone enn der det opprinnelig kjørte.
...
En angriper som klarer å utnytte sikkerhetsproblemet med tilgjengeliggjøring av informasjon, kan lese informasjonskapsler eller andre data fra en annen sikkerhetssone eller et annet domene i Internet Explorer.
...
Oppdateringen tvinger frem sikkerhetskontroller når objektet for vindusplassering angis.

**Var dette sikkerhetsproblemet offentliggjort da denne sikkerhetsbulletinen ble publisert?**    
Ja. Dette sikkerhetsproblemet er publisert. Det er tildelt Common Vulnerability and Exposure-nummer CVE-2008-2947. Ytterligere CVE-numre som viser til det samme sikkerhetsproblemet, er CVE-2008-2948 og CVE-2008-2949.
...
## Sikkerhetsproblem med HTML-element på tvers av domener – CVE-2008-3472

Det finnes et sikkerhetsproblem i Internet Explorer som kan føre til ekstern kjøring av kode eller tilgjengeliggjøring av informasjon, og som kan gjøre det mulig for skript å få tilgang til et webleservindu i et annet domene eller en annen Internet Explorer-sone. En angriper kan utnytte sikkerhetsproblemet ved å opprette en spesiallaget webside som kan tillate ekstern kjøring av kode eller tilgjengeliggjøring av informasjon, avhengig av operativsystemet, hvis en bruker viser websiden.

Hvis du vil se dette sikkerhetsproblemet som en standardoppføring i listen Common Vulnerabilities and Exposures, kan du se [CVE-2008-3472](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3472).

#### Begrensende faktorer for sikkerhetsproblemet med HTML-element på tvers av domener – CVE-2008-3472
...
#### Midlertidige løsninger for sikkerhetsproblemet med HTML-element på tvers av domener – CVE-2008-3472
...
#### Vanlige spørsmål om sikkerhetsproblemet med HTML-element på tvers av domener – CVE-2008-3472

**Hva er omfanget av sikkerhetsproblemet?**  
Dette er et sikkerhetsproblem som kan føre til ekstern kjøring av kode for Internet Explorer 6 Service Pack 1 som kjører på Microsoft Windows 2000 Service Pack 4. En angriper som utnytter dette sikkerhetsproblemet, kan få samme brukerrettigheter som den påloggede brukeren.
...
**Hva gjør oppdateringen?**    
Oppdateringen tvinger frem sikkerhetspolicyer på tvers av domener på riktig måte i forbindelse med kjøring av skript.
...
## Sikkerhetsproblem med hendelseshåndtering på tvers av domener – CVE-2008-3473

Det finnes et sikkerhetsproblem i Internet Explorer som kan føre til ekstern kjøring av kode eller tilgjengeliggjøring av informasjon, og som kan gjøre det mulig for skript å få tilgang til et webleservindu i et annet domene eller en annen Internet Explorer-sone. En angriper kan utnytte sikkerhetsproblemet ved å opprette en spesiallaget webside som kan tillate ekstern kjøring av kode eller tilgjengeliggjøring av informasjon, avhengig av operativsystemet, hvis en bruker viser websiden.

Hvis du vil se dette sikkerhetsproblemet som en standardoppføring i listen Common Vulnerabilities and Exposures, kan du se [CVE-2008-3473](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3473).

#### Begrensende faktorer for sikkerhetsproblemet med hendelseshåndtering på tvers av domener – CVE-2008-3473
...
#### Midlertidige løsninger for sikkerhetsproblemet med hendelseshåndtering på tvers av domener – CVE-2008-3473
...
#### Vanlige spørsmål om sikkerhetsproblemet med hendelseshåndtering på tvers av domener – CVE-2008-3473
...
**Hva gjør oppdateringen?**    
Oppdateringen korrigerer identifiseringen av domenet til et skript som kjøres, noe som begrenser det til å kjøre i konteksten til det opprinnelige domenet.
...
## Sikkerhetsproblem som kan føre til tilgjengeliggjøring av informasjon på tvers av domener – CVE-2008-3474

Det finnes et sikkerhetsproblem i Internet Explorer som kan føre til tilgjengeliggjøring av informasjon, og som kan gjøre det mulig for skript å få tilgang til et webleservindu i et annet domene eller en annen Internet Explorer-sone. En angriper kan utnytte sikkerhetsproblemet ved å lage et spesiallaget webområde som kan føre til tilgjengeliggjøring av informasjon hvis en bruker besøker webområdet.

Hvis du vil se dette sikkerhetsproblemet som en standardoppføring i listen Common Vulnerabilities and Exposures, kan du se [CVE-2008-3474](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3474).

#### Begrensende faktorer for sikkerhetsproblemet som kan føre til tilgjengeliggjøring av informasjon på tvers av domener – CVE-2008-3474
...
#### Midlertidige løsninger for sikkerhetsproblemet som kan føre til tilgjengeliggjøring av informasjon på tvers av domener – CVE-2008-3474
...
#### Vanlige spørsmål om sikkerhetsproblemet som kan føre til tilgjengeliggjøring av informasjon på tvers av domener – CVE-2008-3474

**Hva er omfanget av sikkerhetsproblemet?**    
Dette er et sikkerhetsproblem som kan føre til tilgjengeliggjøring av informasjon. En angriper som klarer å utnytte dette sikkerhetsproblemet, kan lese informasjonskapsler eller andre data fra et annet domene eller en annen Internet Explorer-sikkerhetssone. Brukermedvirkning er imidlertid nødvendig for å utnytte sikkerhetsproblemet.
...
## Sikkerhetsproblem med feil i ikke-initialisert minne - CVE-2008-3475
...
Hvis du vil se dette sikkerhetsproblemet som en standardoppføring i listen Common Vulnerabilities and Exposures, kan du se [CVE-2008-3475](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3475).

#### Begrensende faktorer for sikkerhetsproblemet som kan føre til minnefeil – CVE-2008-3475
...
Begrensning viser til en innstilling, vanlig konfigurering eller generell god fremgangsmåte som finnes i standardtilstanden og kan redusere alvorlighetsgraden til utnyttelsen av et sikkerhetsproblem. Følgende begrensende faktorer kan være nyttige i din situasjon:
  ...
  - Alle støttede versjoner av Microsoft Outlook og Microsoft Outlook Express åpner som standard e-postmeldinger i HTML-format i sonen Begrensede områder. Sonen Begrensede områder bidrar til å begrense angrep som kan forsøke å utnytte dette sikkerhetsproblemet, ved å hindre at Aktiv skripting og ActiveX-kontroller brukes ved lesing av e-postmeldinger i HTML-format. Hvis brukeren imidlertid klikker en kobling i en e-postmelding, kan brukeren fremdeles være sårbar overfor dette sikkerhetsproblemet gjennom det webbaserte angrepsscenariet.
  - Som standard kjører Internet Explorer på Windows Server 2003, og Windows Server 2008 kjører i en begrenset modus, kjent som [Utvidet sikkerhetskonfigurasjon](http://go.microsoft.com/fwlink/?linkid=92039). Denne modusen setter sikkerhetsnivået for Internett-sonen til Høy. Dette er en begrensende faktor for webområder som du ikke har lagt til i sonen Klarerte områder i Internet Explorer. Se delen Vanlige spørsmål for dette sikkerhetsproblemet for å få mer informasjon om Utvidet sikkerhetskonfigurasjon for Internet Explorer.
  - Windows Internet Explorer 7 er ikke berørt av dette sikkerhetsproblemet.

#### Midlertidige løsninger for sikkerhetsproblemet som kan føre til minnefeil – CVE-2008-3475
...
#### Vanlige spørsmål for sikkerhetsproblemet som kan føre til minnefeil – CVE-2008-3475
...
**Hva gjør oppdateringen?**    
Oppdateringen endrer måten som Internet Explorer håndterer feil på i forbindelse med kall til uinitialiserte eller slettede objekter.
...
## Sikkerhetsproblem med HTML-objekter som kan føre til minnefeil – CVE-2008-3476
...
Hvis du vil se dette sikkerhetsproblemet som en standardoppføring i listen Common Vulnerabilities and Exposures, kan du se [CVE-2008-3476](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3476).

#### Begrensende faktorer for sikkerhetsproblemet med HTML-objekter som kan føre til minnefeil – CVE-2008-3476
...
#### Midlertidige løsninger for sikkerhetsproblemet med HTML-objekter som kan føre til minnefeil – CVE-2008-3476
...
#### Vanlige spørsmål om sikkerhetsproblemet med HTML-objekter som kan føre til minnefeil – CVE-2008-3476

**Hva er omfanget av sikkerhetsproblemet?**    
Dette er et sikkerhetsproblem som kan forårsake ekstern kjøring av kode. En angriper som klarer å utnytte dette sikkerhetsproblemet, kan oppnå samme brukerrettigheter som den påloggede brukeren. Hvis en bruker er logget på med administrative rettigheter, kan en angriper som klarte å utnytte dette sikkerhetsproblemet, ta kontroll over det berørte systemet. En angriper kan deretter installere programmer, vise, endre eller slette data, eller opprette nye kontoer med fullstendige brukerrettigheter. Brukere med kontoer som er konfigurert med få brukerrettigheter på systemet, er mindre utsatt enn brukere som har administrative rettigheter.

**Hva forårsaker sikkerhetsproblemet?**    
Internet Explorer forsøker å få tilgang til ikke-initialisert minne. Som en følge av dette kan minnet bli skadet, slik at en angriper kan kjøre vilkårlig kode i omgivelsene til den påloggede brukeren.
...
<td style="border:1px solid black;">For Internet Explorer 5.01 Service Pack 4 på alle støttede versjoner av Windows 2000:<br />
Bruk verktøyet Legg til eller fjern programmer i Kontrollpanel eller Spuninst.exe-verktøyet som ligger i mappen %Windir%\\$NTUninstallKB956390-IE501SP4-20080820.120000$\Spuninst<br />
<br />
For Internet Explorer 6 Service Pack 1 når installert på alle støttede versjoner av Windows 2000:<br />
Bruk verktøyet Legg til eller fjern programmer i Kontrollpanel eller Spuninst.exe-verktøyet som ligger i mappen %Windir%\\$NTUninstallKB956390-IE6SP1-20080820.120000$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Filinformasjon</strong></td>
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/956390">Microsoft Knowledge Base-artikkel 956390</a></td>
</tr>
<tr class="even">
...
Bruk verktøyet Legg til eller fjern programmer i Kontrollpanel eller Spuninst.exe-verktøyet som ligger i mappen %Windir%\$NTUninstal\KB956390$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 for Windows XP:<br />
Bruk verktøyet Legg til eller fjern programmer i Kontrollpanel eller Spuninst.exe-verktøyet som ligger i mappen %Windir%\ie7updates\KB956390-IE7\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Filinformasjon</strong></td>
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/956390">Microsoft Knowledge Base-artikkel 956390</a></td>
...
Bruk verktøyet Legg til eller fjern programmer i Kontrollpanel eller Spuninst.exe-verktøyet som ligger i mappen %Windir%\\$NTUninstallKB956390$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
Microsoft [takker](http://go.microsoft.com/fwlink/?linkid=21127) følgende for samarbeidet med å beskytte kundene:
  ...
  - David Bloom for rapporten om sikkerhetsproblemet med HTML-element på tvers av domener (CVE-2008-3472)
  - Gregory Rubin for rapporten om sikkerhetsproblemet med hendelseshåndtering på tvers av domener (CVE-2008-3473)
  - [Ivan Fratric](http://ifsec.blogspot.com/), i samarbeid med [TippingPoint](http://www.tippingpoint.com/) og [Zero Day Initiative](http://www.zerodayinitiative.com/) for rapporten om sikkerhetsproblemet med feil i ikke-initialisert minne (CVE-2008-3475)
  - Thierry Zoller hos [n.runs](http://www.nruns.com/) for rapporten om sikkerhetsproblemet med HTML-objekter som kan føre til minnefeil (CVE-2008-3476)
  - Lee Dagon hos [Composica](http://www.composica.com/) for rapporten om sikkerhetsproblemet med tilgjengeliggjøring informasjon på tvers av domener (CVE-2008-3474)
...
#### Revisjoner
  ...
  - V1.1 (15. oktober 2008): Korrigerte en oppføring for kontroll av registernøkkel for Windows Server 2003, og korrigerte filinformasjonskoblinger.
  - V1.2 (12. november 2008): Korrigerte en oppføring for kontroll av registernøkkel for Internet Explorer 6 for alle støttede x64-baserte versjoner av Windows Server 2003.
