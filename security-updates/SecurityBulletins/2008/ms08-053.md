...
<td style="border:1px solid black;">Windows Media Encoder 9 Series</td>
</tr>
<tr class="even">
...
<th style="border:1px solid black;">Sikkerhetsproblem med bufferoverløp i Windows Media Encoder – CVE-2008-3008</th>
<th style="border:1px solid black;">Samlet alvorlighetsgrad</th>
</tr>
</thead>
<tbody>
...
<td style="border:1px solid black;">Oppdateringen for dette problemet vil ikke bli inkludert i en fremtidig samleoppdatering.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">For Windows Media Encoder 9 Series som kjører på Microsoft Windows 2000 Service Pack 4:<br />
...
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/954156">Microsoft Knowledge Base-artikkel 954156</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kontroll av registernøkkel</strong></td>
<td style="border:1px solid black;">For Windows Media Encoder 9 Series som kjører på Microsoft Windows Service Pack 4: 
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Inkludert i fremtidige oppdateringspakker</strong></td>
<td style="border:1px solid black;">Oppdateringen for dette problemet inkluderes ikke i en fremtidig oppdateringspakke eller samleoppdatering.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Distribusjon</strong></td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Installasjon uten brukermedvirkning</td>
<td style="border:1px solid black;">For Windows Media Encoder 9 Series som kjører på Windows XP Service Pack 2 og Windows XP Service Pack 3:<br />
WindowsMedia9-KB954156-x86-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For Windows Media Encoder 9 Series x64 Edition som kjører på Windows XP Professional x64 Edition og Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsMedia9-KB954156-x64-ENU /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For Windows Media Encoder 9 Series som kjører på Windows XP Professional x64 Edition og Windows XP Professional x64 Edition Service Pack 2:
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informasjon om fjerning</strong></td>
<td style="border:1px solid black;">For Windows Media Encoder 9 Series bruker du verktøyet Legg til eller fjern programmer i Kontrollpanel eller Spuninst.exe-verktøyet som ligger i mappen %Windir%\\$NTUninstallKB954156_WM9L$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For Windows Media Encoder 9 Series x64 Edition bruker du verktøyet Legg til eller fjern programmer i Kontrollpanel eller Spuninst.exe-verktøyet som ligger i mappen %Windir%\\$NTUninstallKB954156_WM10L$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Filinformasjon</strong></td>
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/954156">Microsoft Knowledge Base-artikkel 954156</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Installasjon uten brukermedvirkning</td>
<td style="border:1px solid black;">For Windows Media Encoder 9 Series som kjører på Windows Server 2003 Service Pack 1 og Windows Server 2003 Service Pack 2:<br />
WindowsMedia9-KB954156-x86-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For Windows Media Encoder 9 Series x64 Edition som kjører på Windows Server 2003 x64 Edition og Windows Server 2003 x64 Edition Service Pack 2:<br />
WindowsMedia9-KB954156-x64-ENU /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For Windows Media Encoder 9 Series som kjører på Windows Server 2003 x64 Edition og Windows Server 2003 x64 Edition Service Pack 2:
<p>WindowsMedia9-KB954156-32bit-x64-ENU /quiet</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;">Kreves omstart?</td>
<td style="border:1px solid black;">I enkelte tilfeller krever ikke denne oppdateringen omstart. Hvis de nødvendige filene er i bruk, krever oppdateringen en omstart. Hvis dette skjer, vises en melding som ber deg om å starte på nytt.
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Kontroll av registernøkkel</strong></td>
<td style="border:1px solid black;">For Windows Media Encoder 9 Series som kjører på Windows Server 2003 Service Pack 1 og Windows Server 2003 Service Pack 2:
<p>HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Media Encoder\SP0\KB954156_WM9L</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For Windows Media Encoder 9 Series x64 Edition som kjører på Windows Server 2003 x64 Edition og Windows Server 2003 x64 Edition Service Pack 2:
...
<tr class="odd">
<td style="border:1px solid black;">Installasjon uten brukermedvirkning</td>
<td style="border:1px solid black;">For Windows Media Encoder 9 Series som kjører på Windows Vista og Windows Vista Service Pack 1:<br />
...
<td style="border:1px solid black;">Angir stille modus, eller undertrykker forespørsler.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Pakker ut filene uten å installere dem. Hvis <strong>/t:bane</strong> ikke er angitt, blir du spurt etter en målmappe</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Ber brukeren om å starte datamaskinen på nytt hvis en omstart kreves, unntatt ved bruk sammen med <strong>/q:a</strong>.</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">Installasjon uten brukermedvirkning</td>
<td style="border:1px solid black;">For Windows Media Encoder 9 Series som kjører på Windows Server 2008 for 32-biters systemer:<br />
WindowsMedia9-KB954156-INTL /q:a<br />
<br />
...
<tr class="even">
<td style="border:1px solid black;">Installasjon uten å starte på nytt</td>
<td style="border:1px solid black;">For Windows Media Encoder 9 Series som kjører på Windows Server 2008:<br />
WindowsMedia9-KB954156-INTL /r:n<br />
<br />
...
<tr class="odd">
<td style="border:1px solid black;">Kreves omstart?</td>
<td style="border:1px solid black;">Vanligvis krever ikke denne oppdateringen omstart. Hvis de nødvendige filene er i bruk, krever oppdateringen en omstart. Hvis dette skjer, vises en melding som ber deg om å starte på nytt.
<p>Hvis du stopper alle berørte tjenester og lukker alle programmene som bruker de berørte filene før installasjon av sikkerhetsoppdateringen, er det mindre sannsynlig at det blir nødvendig å starte maskinen på nytt. Hvis du vil ha mer informasjon om årsakene til at du kan bli bedt om å starte datamaskinen på nytt.</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Hotpatching</td>
