  ...
  <tr class="thead">
    ...
    <th style="border:1px solid black;">Bulletiner som erstattes av denne oppdateringen</th>
          ...
          <tr class="alternateRow"><td style="border:1px solid black;">
              ...
              <br />(KB953404)</td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Viktig</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://go.microsoft.com/fwlink/?linkid=112112">MS08-016</a>
            </td></tr>
          <tr><td style="border:1px solid black;">
              ...
              <br />(KB953404)</td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Viktig</td><td style="border:1px solid black;">Ingen</td></tr>
          <tr class="alternateRow"><td style="border:1px solid black;">
              ...
              <br />(KB951944)</td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Viktig</td><td style="border:1px solid black;">
          ...
          <tr><td style="border:1px solid black;">
              ...
              <br />(KB951944)</td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Viktig</td><td style="border:1px solid black;">Ingen</td></tr>
          ...
          <tr class="alternateRow"><td style="border:1px solid black;">
              ...
              <br />(KB950130)<br /><br /><a Target="" runat="server" href="http://www.microsoft.com/downloads/details.aspx?familyid=8ac3576c-7873-4ac6-8bbc-033f6a7bb395">Microsoft Office OneNote 2007 Service Pack 1</a><br />(KB950130)</td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Kritisk</td><td style="border:1px solid black;">Ingen</td></tr>
        </table>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Office OneNote 2003 Service Pack 2</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office OneNote 2003 Service Pack 3</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Office PowerPoint 2007 Viewer</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office PowerPoint Viewer 2007 Service Pack 1</td>
</tr>
<tr class="even">
...
## Alvorlighetsgrader og identifikatorer for sikkerhetsproblem
 ...
 <table style="border:1px solid black;" class="dataTable">
          ...
          <tr class="thead"><th style="border:1px solid black;">Berørt programvare</th><th style="border:1px solid black;">Sikkerhetsproblem med feil URL-validering (Uniform Resource Locator) – CVE-2008-3007 </th><th style="border:1px solid black;">Samlet alvorlighetsgrad</th></tr>
            ...
            <tr><td style="border:1px solid black;">Microsoft Office OneNote 2007 og Microsoft Office OneNote 2007 Service Pack 1</td><td style="border:1px solid black;">
...
<tr class="even">
<td style="border:1px solid black;">Office 2003 Service Pack 2 og Office 2003 Service Pack 3</td>
<td style="border:1px solid black;">Ja</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;">OneNote 2007 og OneNote 2007 Service Pack 1</td>
<td style="border:1px solid black;">Ja</td>
</tr>
</tbody>
</table>
...
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/955047">Microsoft Knowledge Base-artikkel 955047</a></td>
</tr>
<tr class="even">
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">ACCESS, FP, OUTLOOK, PPT, ACCESSRT, PUB, PRJPRO, PRJSTD</td>
...
<td style="border:1px solid black;">WORDNonBootFiles,ProductFiles</td>
</tr>
<tr class="even">
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">ACCESSRT, ACC11</td>
<td style="border:1px solid black;">ACCESSNonBootFiles,ProductFiles</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">OUTLS11, VISVEA, PPT11, FP11, ONOTE11, OUTL11, OUTLSM11, PUB11, INF11, PRJPROE, PRJPRO, PRJSTDE, PRJSTD, VISPRO, VISPROR, VISSTD, VISSTDR</td>
<td style="border:1px solid black;">ProductFiles</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">RMS</td>
<td style="border:1px solid black;">RMSFiles,ProductFiles</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">BASIC11, PERS11, STDP11, STD11</td>
<td style="border:1px solid black;">WORDNonBootFiles,EXCELNonBootFiles,ProductFiles</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">PRO11SB, PROI11, PRO11</td>
<td style="border:1px solid black;">WORDNonBootFiles,ACCESSNonBootFiles,EXCELNonBootFiles,ProductFiles</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">WORD11</td>
<td style="border:1px solid black;">WORDNonBootFiles,ProductFiles</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">EXCEL11</td>
<td style="border:1px solid black;">EXCELNonBootFiles,ProductFiles</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Office 2007, VWD, Expression Web</td>
<td style="border:1px solid black;">ProductFiles</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">OneNote 2007</td>
<td style="border:1px solid black;">ProductFiles</td>
</tr>
</tbody>
</table>
