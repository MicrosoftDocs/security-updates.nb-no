  ...
  <tr class="thead">
    ...
    <th style="border:1px solid black;">Bulletiner som erstattes av denne oppdateringen</th>
          ...
          <tr><td style="border:1px solid black;">Microsoft Office 2000 Service Pack 3</td><td style="border:1px solid black;">
              ...
              <br />(KB950250)</td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Kritisk</td><td style="border:1px solid black;">
          ...
          <tr class="alternateRow"><td style="border:1px solid black;">Microsoft Office XP Service Pack 3</td><td style="border:1px solid black;">
              ...
              <br />(KB950243)</td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Viktig</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://go.microsoft.com/fwlink/?linkid=110056">MS08-009</a>
            </td></tr>
          <tr><td style="border:1px solid black;">Microsoft Office 2003 Service Pack 2</td><td style="border:1px solid black;">
              ...
              <br />(KB950241)</td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Viktig</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://go.microsoft.com/fwlink/?linkid=110056">MS08-009</a>
            </td></tr>
          ...
          <tr><td style="border:1px solid black;">2007 Microsoft Office System</td><td style="border:1px solid black;">
              ...
              <br />(KB950113)</td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Viktig</td><td style="border:1px solid black;">Ingen</td></tr>
          <tr class="alternateRow"><td /><td style="border:1px solid black;">
              ...
              <br />(KB950113)</td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Kritisk</td><td style="border:1px solid black;">Ingen</td></tr>
          ...
          <tr><td style="border:1px solid black;">
              ...
              <br />(KB950625)</td><td style="border:1px solid black;">Ikke relevant</td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Viktig</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://go.microsoft.com/fwlink/?linkid=110056">MS08-009</a>
            </td></tr>
          ...
          <tr><td style="border:1px solid black;">
              ...
              <br />(KB951808)</td><td style="border:1px solid black;">Ikke relevant</td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Viktig</td><td style="border:1px solid black;">Ingen </td></tr>
          <tr class="alternateRow"><td style="border:1px solid black;">
          ...
          <tr><td style="border:1px solid black;">
              ...
              <br />(KB952332)</td><td style="border:1px solid black;">Ikke relevant</td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Viktig</td><td style="border:1px solid black;">
          ...
          <tr class="alternateRow"><td style="border:1px solid black;">
              ...
              <br />(KB952331)</td><td style="border:1px solid black;">Ikke relevant</td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Viktig</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://go.microsoft.com/fwlink/?linkid=112111">MS08-014</a>
            </td></tr>
        </table>
...
<th style="border:1px solid black;">Sikkerhetsproblem ved objektsanalyse – CVE-2008-1091</th>
<th style="border:1px solid black;">Sikkerhetsproblem ved CSS-dokumenter (Cascading Style Sheet) i Word – CVE-2008-1434</th>
<th style="border:1px solid black;">Samlet alvorlighetsgrad</th>
</tr>
</thead>
<tbody>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Word 2003 Service Pack 2 og Microsoft Word 2003 Service Pack 3</td>
<td style="border:1px solid black;"><strong>Viktig</strong><br />
Ekstern kjøring av kode</td>
<td style="border:1px solid black;"><strong>Viktig</strong><br />
Ekstern kjøring av kode</td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Word Viewer 2003 og Microsoft Word Viewer 2003 Service Pack 3</td>
<td style="border:1px solid black;"><strong>Viktig</strong><br />
Ekstern kjøring av kode</td>
<td style="border:1px solid black;"><strong>Viktig</strong><br />
Ekstern kjøring av kode</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Word 2007 og Microsoft Word 2007 Service Pack 1</td>
<td style="border:1px solid black;"><strong>Viktig</strong><br />
Ekstern kjøring av kode</td>
<td style="border:1px solid black;"><strong>Viktig</strong><br />
Ekstern kjøring av kode</td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Outlook 2007 og Microsoft Outlook 2007 Service Pack 1</td>
<td style="border:1px solid black;"><strong>Kritisk</strong><br />
Ekstern kjøring av kode</td>
<td style="border:1px solid black;"><strong>Viktig</strong><br />
Ekstern kjøring av kode</td>
...
#### Midlertidige løsninger for sikkerhetsproblemet ved objektsanalyse – CVE-2008-1091
...
#### Vanlige spørsmål om sikkerhetsproblemet ved CSS-dokumenter (Cascading Style Sheet) i Word – CVE-2008-1434
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Outlook 2007 Service Pack 1</td>
<td style="border:1px solid black;">Ja</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/951207">Microsoft Knowledge Base-artikkel 951207</a>.</td>
</tr>
<tr class="even">
...
#### Word 2003 og Word 2003 Viewer (alle versjoner)
...
Hvis versjonsnummeret er **12.1.0**, er oppdateringen installert.
...
#### Revisjoner
  ...
  - V1.1 (14. mai 2008): Avsnittene om distribusjonsinformasjon er oppdatert for Office 2004 for Mac og Office 2008 for Mac for å inkludere kobling til Microsoft Download Center. Det er også lagt til en oppføring under Vanlige spørsmål for oppdateringen for å informere om hvorfor oppdateringen for Outlook 2007 har alvorlighetsgraden Kritisk.
