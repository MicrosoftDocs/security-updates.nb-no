...
<tr class="even">
<td>Krever omstart</td>
<td>Nei, du trenger ikke å starte systemet på nytt etter at du har installert denne sikkerhetsoppdateringen</td>
</tr>
<tr class="odd">
<td><strong>Informasjon om fjerning</strong></td>
...
<table class="dataTable" xmlns="http://www.w3.org/1999/xhtml">
                  ...
                  <tr class="thead"><th>Bryter</th><th>Beskrivelse</th></tr>
                    ...
                    <tr class="alternateRow"><td>
                        <strong>/q [:u | :a]</strong>
                      </td><td>/q    – Angir stille modus eller undertrykker forespørsler.<p>/q:u – Angir stille brukermodus som viser noen dialogbokser for brukeren.</p><p>/q:a – Angir stille administratormodus som ikke viser noen dialogbokser for brukeren.</p></td></tr>
                    ...
                    <tr><td>
                        <strong>/C</strong>
                      </td><td>Pakker ut filene uten å installere dem. Hvis /t: bane ikke er angitt, blir du spurt etter en målmappe.</td></tr>
                    <tr class="alternateRow"><td>
                        <strong>/T:bane</strong>
                      </td><td>Angir målmappen der filene skal pakkes ut.</td></tr>
                    <tr><td>
                        <strong>/C:bane</strong>
                      </td><td>Angir UNC-banen og navnet til Setup.inf- eller EXE-filen.</td></tr>
                    <tr class="alternateRow"><td>
                        <strong>/n:v</strong>
                      </td><td>Ingen versjonskontroll. Installer pakken over eventuelle tidligere versjoner.</td></tr>
                    ...
                    <tr><td>
                        <strong>/r:n</strong>
                      </td><td>Starter aldri systemet på nytt etter installasjonen.</td></tr>
                    <tr class="alternateRow"><td>
                        <strong>/r:i</strong>
                      </td><td>Ber brukeren om å starte systemet på nytt hvis en omstart kreves, unntatt ved bruk sammen med /q:a.</td></tr>
                    <tr><td>
                        <strong>/r:a</strong>
                      </td><td>Starter alltid systemet på nytt etter installasjonen.</td></tr>
                    <tr class="alternateRow"><td>
                        <strong>/r:s</strong>
                      </td><td>Starter datamaskinen på nytt etter installasjonen uten å spørre brukeren.</td></tr>
