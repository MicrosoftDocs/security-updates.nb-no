...
<table style="border:1px solid black;" class="dataTable">
  <tr class="thead">
    ...
    <th style="border:1px solid black;">Bulletiner som erstattes av denne oppdateringen</th>
          ...
          <tr><th colspan="5" style="border:1px solid black;">DirectX 9.0</th></tr>
...
<th style="border:1px solid black;">Sikkerhetsproblem med MJPEG-dekoder – CVE-2008-0011</th>
<th style="border:1px solid black;">Sikkerhetsproblem med analyse av SAMI-format – CVE-2008-1444</th>
<th style="border:1px solid black;">Samlet alvorlighetsgrad</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4 med DirectX 7.0</td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4 med DirectX 8.1</td>
<td style="border:1px solid black;"><strong>Kritisk</strong><br />
Ekstern kjøring av kode</td>
<td style="border:1px solid black;"><strong>Kritisk</strong><br />
Ekstern kjøring av kode</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4 med DirectX 9.0, DirectX 9.0a, DirectX 9.0b eller DirectX 9.0c</td>
<td style="border:1px solid black;"><strong>Kritisk</strong><br />
Ekstern kjøring av kode</td>
<td style="border:1px solid black;">Ikke berørt</td>
<td style="border:1px solid black;"><strong>Kritisk</strong></td>
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4 med DirectX 7.0:
...
<td style="border:1px solid black;">I enkelte tilfeller krever ikke denne oppdateringen omstart. Hvis de nødvendige filene er i bruk, krever oppdateringen en omstart. Hvis det skjer, vises det en melding som ber deg om å starte på nytt.<br />
<br />
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4 med DirectX 7.0:<br />
...
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/951698">Microsoft Knowledge Base-artikkel 951698</a>.</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informasjon om fjerning</strong></td>
<td style="border:1px solid black;">Bruk verktøyet Legg til eller fjern programmer i Kontrollpanel eller Spuninst.exe-verktøyet som ligger i mappen %Windir%\\$NTUninstallKB951698$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Filinformasjon</strong></td>
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/951698">Microsoft Knowledge Base-artikkel 951698</a>.</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informasjon om fjerning</strong></td>
<td style="border:1px solid black;">Bruk verktøyet <strong>Legg til eller fjern programmer</strong> i Kontrollpanel eller Spuninst.exe-verktøyet som ligger i mappen %Windir%\\$NTUninstallKB951698$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Filinformasjon</strong></td>
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/951698">Microsoft Knowledge Base-artikkel 951698</a>.</td>
