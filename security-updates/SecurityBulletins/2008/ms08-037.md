...
<thead>
<tr class="header">
<th style="border:1px solid black;">DNS-kilent (951748)</th>
<th style="border:1px solid black;">DNS-server (951746)</th>
...
<td style="border:1px solid black;">Se raden nedenfor</td>
...
<tr class="even">
<td style="border:1px solid black;">Se raden ovenfor</td>
...
<tr class="odd">
<td style="border:1px solid black;">Se raden ovenfor</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=d1fcb794-e6a5-4c28-b3b3-9cd88f468a42">Windows Server 2003 Service Pack 1 og Windows Server 2003 Service Pack 2</a></td>
<td style="border:1px solid black;">Etterligningsangrep</td>
<td style="border:1px solid black;">Viktig</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=99391">MS07-062</a></td>
</tr>
...
<tr class="even">
<td style="border:1px solid black;">Se raden ovenfor</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=040a1ba8-21b0-439e-bf21-1acd1c43b162">Windows Server 2003 x64 Edition og Windows Server 2003 x64 Edition Service Pack 2</a></td>
<td style="border:1px solid black;">Etterligningsangrep</td>
<td style="border:1px solid black;">Viktig</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=99391">MS07-062</a></td>
</tr>
...
<tr class="odd">
<td style="border:1px solid black;">Se raden ovenfor</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c63e3ee6-6055-4313-b0f1-fec7408886bb">Windows Server 2003 SP1 for Itanium-based Systems og Windows Server 2003 SP2 for Itanium-based Systems</a></td>
<td style="border:1px solid black;">Etterligningsangrep</td>
<td style="border:1px solid black;">Viktig</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=99391">MS07-062</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Ikke relevant</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1fcea8f4-b233-42e1-b913-c4fcae276c7b">Windows Server 2008 for 32-biters systemer</a>*</td>
<td style="border:1px solid black;">Etterligningsangrep</td>
<td style="border:1px solid black;">Viktig</td>
<td style="border:1px solid black;">Ingen</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Ikke relevant</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=afac5bbc-71fa-457b-8b0a-f5902d37bfd0">Windows Server 2008 for x64-baserte systemer</a>*</td>
<td style="border:1px solid black;">Etterligningsangrep</td>
<td style="border:1px solid black;">Viktig</td>
<td style="border:1px solid black;">Ingen</td>
</tr>
...
<th style="border:1px solid black;">DNS-sikkerhetsproblem med utilstrekkelig socket-entropi i DNS – CVE-2008-1447</th>
<th style="border:1px solid black;">DNS-sikkerhetsproblem med hurtigbufferskade i DNS – CVE-2008-1454</th>
<th style="border:1px solid black;">Samlet alvorlighetsgrad</th>
</tr>
</thead>
<tbody>
...
<td style="border:1px solid black;">Nei</td>
<td style="border:1px solid black;">Nei</td>
<td style="border:1px solid black;">Se <strong>Merknad for Windows Server 2008</strong> nedenfor</td>
<td style="border:1px solid black;">Ja</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008 for x64-baserte systemer</td>
...
<td style="border:1px solid black;">For DNS-serveroppdateringen for Microsoft Windows 2000 Service Pack 4:<br />
...
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/953230">Microsoft Knowledge Base-artikkel 953230</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kontroll av registernøkkel</strong></td>
<td style="border:1px solid black;">For DNS-serveroppdateringen for Microsoft Windows 2000 Service Pack 4: 
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informasjon om fjerning</strong></td>
<td style="border:1px solid black;">Bruk verktøyet Legg til eller fjern programmer i Kontrollpanel eller Spuninst.exe-verktøyet som ligger i mappen %Windir%\\$NTUninstallkb951748$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Filinformasjon</strong></td>
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/953230">Microsoft Knowledge Base-artikkel 953230</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Kontroll av registernøkkel</strong></td>
<td style="border:1px solid black;">For Windows XP Service Pack 2 og Windows XP Service Pack 3:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Installasjon uten brukermedvirkning</td>
<td style="border:1px solid black;">For DNS-serveroppdateringen for alle støttede 32-biters versjoner av Windows Server 2003:<br />
Windowsserver2003-kb951746-x86-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For DNS-klientoppdateringen for alle støttede 32-biters versjoner av Windows Server 2003:<br />
Windowsserver2003-kb951748-x86-enu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For DNS-serveroppdateringen for alle støttede x64-baserte versjoner av Windows Server 2003:<br />
Windowsserver2003.WindowsXP-kb951746-x64-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For DNS-klientoppdateringen for alle støttede x64-baserte versjoner av Windows Server 2003:<br />
Windowsserver2003.WindowsXP-kb951748-x64-enu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For DNS-serveroppdateringen for alle støttede Itanium-based-versjoner av Windows Server 2003:<br />
Windowsserver2003-kb951746-ia64-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For DNS-klientoppdateringen for alle støttede Itanium-based-versjoner av Windows Server 2003:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Oppdater loggfil</td>
<td style="border:1px solid black;">For DNS-serveroppdateringen for Windows Server 2003: kb951746.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For DNS-klientoppdateringen for Windows Server 2003: kb951748.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Mer informasjon</td>
<td style="border:1px solid black;">Se avsnittet <strong>Veiledning og verktøy for søking og distribusjon</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informasjon om fjerning</strong></td>
<td style="border:1px solid black;">For DNS-serveroppdateringen for Windows Server 2003 bruker du verktøyet <strong>Legg til eller fjern programmer</strong> i Kontrollpanel eller Spuninst.exe-verktøyet som ligger i mappen %Windir%\\$NTUninstallkb951746$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For DNS-klientoppdateringen for Windows Server 2003 bruker du verktøyet <strong>Legg til eller fjern programmer</strong> i Kontrollpanel eller Spuninst.exe-verktøyet som ligger i mappen %Windir%\\$NTUninstallkb951748$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Filinformasjon</strong></td>
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/953230">Microsoft Knowledge Base-artikkel 953230</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Kontroll av registernøkkel</strong></td>
<td style="border:1px solid black;">For DNS-serveroppdateringen for Windows Server 2003: HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\kb951746\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For DNS-klientoppdateringen for Windows Server 2003: HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\kb951748\Filelist</td>
</tr>
</tbody>
</table>
