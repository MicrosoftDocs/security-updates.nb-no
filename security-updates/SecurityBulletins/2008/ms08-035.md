...
<th style="border:1px solid black;">Sikkerhetsproblem i Active Directory – CVE-2008-1445</th>
<th style="border:1px solid black;">Samlet alvorlighetsgrad</th>
</tr>
</thead>
<tbody>
...
<tr class="even">
<td style="border:1px solid black;">ADAM når installert på Windows XP Professional Service Pack 2 og Windows XP Professional Service Pack 3</td>
<td style="border:1px solid black;"><strong>Moderat </strong><br />
Tjenestenekt</td>
<td style="border:1px solid black;"><strong>Moderat</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ADAM når installert på Windows XP Professional x64 Edition og Windows XP Professional x64 Edition Service Pack 2:</td>
<td style="border:1px solid black;"><strong>Moderat </strong><br />
Tjenestenekt</td>
<td style="border:1px solid black;"><strong>Moderat</strong></td>
</tr>
...
<tr class="odd">
<td style="border:1px solid black;">Active Directory på Windows Server 2008 for 32-biters systemer*</td>
<td style="border:1px solid black;"><strong>Moderat</strong><br />
Tjenestenekt</td>
<td style="border:1px solid black;"><strong>Moderat</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">AD LDS på Windows Server 2008 for 32-biters systemer*</td>
<td style="border:1px solid black;"><strong>Moderat</strong><br />
Tjenestenekt</td>
<td style="border:1px solid black;"><strong>Moderat</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Active Directory på Windows Server 2008 for x64-baserte systemer*</td>
<td style="border:1px solid black;"><strong>Moderat</strong><br />
Tjenestenekt</td>
<td style="border:1px solid black;"><strong>Moderat</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">AD LDS på Windows Server 2008 for x64-baserte systemer*</td>
<td style="border:1px solid black;"><strong>Moderat</strong><br />
Tjenestenekt</td>
<td style="border:1px solid black;"><strong>Moderat</strong></td>
</tr>
...
<td style="border:1px solid black;">Microsoft Windows 2000 Server Service Pack 4 med Active Directory:<br />
...
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/953235">Microsoft Knowledge Base-artikkel 953235</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Kontroll av registernøkkel</strong></td>
<td style="border:1px solid black;">Microsoft Windows 2000 Server Service Pack 4 med Active Directory: 
...
<tr class="odd">
<td style="border:1px solid black;">Installasjon uten brukermedvirkning</td>
<td style="border:1px solid black;">Windows XP Professional Service Pack 2 med ADAM og Windows XP Professional Service Pack 3 med ADAM:<br />
Windowsxp-kb949269-x86-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition med ADAM og Windows XP Professional x64 Edition Service Pack 2 med ADAM:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informasjon om fjerning</strong></td>
<td style="border:1px solid black;">Bruk verktøyet Legg til eller fjern programmer i Kontrollpanel eller Spuninst.exe-verktøyet som ligger i mappen %Windir%\\$NTUninstallKB949269$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Filinformasjon</strong></td>
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/953235">Microsoft Knowledge Base-artikkel 953235</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Kontroll av registernøkkel</strong></td>
<td style="border:1px solid black;">For alle støttede 32-biters versjoner av Windows XP Professional:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP\SP4\KB949269\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For alle støttede x64-baserte versjoner av Windows XP Professional:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Installasjon uten brukermedvirkning</td>
<td style="border:1px solid black;">For alle støttede 32-biters versjoner av Windows Server 2003 med Active Directory:<br />
Windowsserver2003-kb949014-x86-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For alle støttede x64-baserte versjoner av Windows Server 2003 med Active Directory:<br />
Windowsserver2003.WindowsXP-KB949014-x64-enu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For alle støttede Itanium-based versjoner av Windows Server 2003 med Active Directory:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informasjon om fjerning</strong></td>
<td style="border:1px solid black;">Bruk verktøyet <strong>Legg til eller fjern programmer</strong> i Kontrollpanel eller Spuninst.exe-verktøyet som ligger i mappen %Windir%\\$NTUninstallKB949014$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Filinformasjon</strong></td>
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/953235">Microsoft Knowledge Base-artikkel 953235</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Installasjon uten brukermedvirkning</td>
<td style="border:1px solid black;">For alle støttede 32-biters versjoner av Windows Server 2003 med ADAM:<br />
Windowsserver2003-kb949269-x86-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For alle støttede x64-baserte versjoner av Windows Server 2003 med ADAM:<br />
Windowsserver2003.WindowsXP-KB949269-x64-enu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For alle støttede Itanium-based versjoner av Windows Server 2003 med ADAM:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informasjon om fjerning</strong></td>
<td style="border:1px solid black;">Bruk verktøyet <strong>Legg til eller fjern programmer</strong> i Kontrollpanel eller Spuninst.exe-verktøyet som ligger i mappen %Windir%\\$NTUninstallKB949269$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Filinformasjon</strong></td>
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/953235">Microsoft Knowledge Base-artikkel 953235</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Installasjon uten brukermedvirkning</td>
<td style="border:1px solid black;">For alle støttede 32-biters versjoner av Windows Server 2008 med Active Directory eller AD LDS:<br />
