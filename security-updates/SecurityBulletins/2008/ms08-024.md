  ...
  <tr class="thead">
    ...
    <th style="border:1px solid black;">Bulletiner som erstattes av denne oppdateringen </th>
          ...
          <tr><td style="border:1px solid black;">Windows Server 2008 for 32-biters systemer*</td><td style="border:1px solid black;">
            ...
            </td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Kritisk</td><td style="border:1px solid black;">Ikke relevant</td></tr>
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Internet Explorer 6 på Windows XP Service Pack 3</td>
</tr>
</tbody>
</table>
...
<th style="border:1px solid black;">Sikkerhetsproblem i dataflythåndtering som kan forårsake minnefeil – CVE-2008-1085</th>
<th style="border:1px solid black;">Samlet alvorlighetsgrad</th>
</tr>
</thead>
<tbody>
...
<tr class="even">
<td style="border:1px solid black;">Internet Explorer 7 for Windows XP Service Pack 2 og Internet Explorer 7 for Windows XP Service Pack 3</td>
<td style="border:1px solid black;"><strong>Kritisk</strong> <br />
Ekstern kjøring av kode</td>
<td style="border:1px solid black;"><strong>Kritisk</strong></td>
</tr>
...
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/947864">Microsoft Knowledge Base-artikkel 947864</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 for Windows XP Service Pack 2 og Internet Explorer 7 for Windows XP Service Pack 3:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 for Windows XP Service Pack 2, Internet Explorer 7 for Windows XP Service Pack 3, Windows XP Professional x64 Edition og Windows XP Professional x64 Edition Service Pack 2:<br />
KB947864-IE7.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Mer informasjon</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Kontroll av registernøkkel</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 for alle støttede versjoner og Itanium-based-versjoner av Windows Server 2003:<br />
