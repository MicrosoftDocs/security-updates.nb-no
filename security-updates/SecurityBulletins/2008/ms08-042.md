---
title: Microsoft Security Bulletin MS08-042 - Important
TOCTitle: MS08-042
ms:assetid: ms08-042
ms:mtpsurl: https://technet.microsoft.com/nb-NO/library/ms08-042(v=Security.10)
ms:contentKeyID: 61231071
ms.date: 04/18/2014
...
## Sikkerhetsproblem i Microsoft Word kan tillate ekstern kjøring av kode (955048)
...
Denne sikkerhetsoppdateringen har alvorlighetsgraden Viktig for alle støttede versjoner av Microsoft Word 2002 og Microsoft Word 2003. Hvis du vil ha mer informasjon, kan du se avsnittet **Berørt og uberørt programvare** i denne delen.

Sikkerhetsoppdateringen løser sikkerhetsproblemet ved å endre måten Microsoft Word håndterer spesiallagde Word-filer på. Hvis du vil ha mer informasjon om sikkerhetsproblemet, kan du se avsnittet Vanlige spørsmål for den bestemte sikkerhetsproblemoppføringen under neste del, **Informasjon om sikkerhetsproblemer**.

Denne oppdateringen omhandler også sikkerhetsproblemet som beskrives i [Microsofts sikkerhetsveiledning 953635](microsoft-security-advisory-953635.md).
  ...
  <tr class="thead">
    ...
    <th style="border:1px solid black;">Bulletiner som erstattes av denne oppdateringen</th>
          ...
          <tr><td style="border:1px solid black;">Microsoft Office XP Service Pack 3</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://www.microsoft.com/downloads/details.aspx?familyid=c7146dfc-e1be-4d13-877b-1d9bcacc4a64">Microsoft Word 2002 Service Pack 3</a> (KB954463)</td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Viktig</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://go.microsoft.com/fwlink/?linkid=117295">MS08-026</a>
            </td></tr>
          <tr class="alternateRow"><td style="border:1px solid black;">Microsoft Office 2003 Service Pack 2</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://www.microsoft.com/downloads/details.aspx?familyid=13a37b76-9fec-426f-8176-3c95f934efe0">Microsoft Word 2003 Service Pack 2</a> (KB954464)</td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Viktig</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://go.microsoft.com/fwlink/?linkid=117295">MS08-026</a>
            </td></tr>
          <tr><td style="border:1px solid black;">Microsoft Office 2003 Service Pack 3</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://www.microsoft.com/downloads/details.aspx?familyid=13a37b76-9fec-426f-8176-3c95f934efe0">Microsoft Word 2003 Service Pack 3</a> (KB954464)</td><td style="border:1px solid black;">Ekstern kjøring av kode</td><td style="border:1px solid black;">Viktig</td><td style="border:1px solid black;">
              <a Target="" runat="server" href="http://go.microsoft.com/fwlink/?linkid=117295">MS08-026</a>
            </td></tr>
        </table>
...
Filinformasjonsdetaljene finner du i [Microsoft Knowledge Base-artikkel 955048](http://support.microsoft.com/kb/955048).
...
<th style="border:1px solid black;">Sikkerhetsproblem i Word ved analyse av poster – CVE-2008-2244</th>
<th style="border:1px solid black;">Samlet alvorlighetsgrad</th>
</tr>
</thead>
<tbody>
...
## Sikkerhetsproblem i Word ved analyse av poster – CVE-2008-2244

Det finnes et sikkerhetsproblem i måten Microsoft Word behandler spesiallagde Word-filer på. Sikkerhetsproblemet kan tillate ekstern kjøring av kode hvis en bruker åpner en spesiallaget Word-fil med en misformet postverdi. En angriper som klarer å utnytte dette sikkerhetsproblemet, kan få full kontroll over et berørt system. En angriper kan deretter installere programmer, vise, endre eller slette data, eller opprette nye kontoer med fullstendige brukerrettigheter.

Hvis du vil se dette sikkerhetsproblemet som en standardoppføring i listen Common Vulnerabilities and Exposures, kan du se [CVE-2008-2244](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2244).

#### Begrensende faktorer for sikkerhetsproblemet i Word ved analyse av poster – CVE-2008-2244
...
#### Midlertidige løsninger for sikkerhetsproblemet i Word ved analyse av poster – CVE-2008-2244
...
#### Vanlige spørsmål om sikkerhetsproblemet i Word ved analyse av poster – CVE-2008-2244
...
Sikkerhetsproblemet forårsakes av minnehåndteringsfeil ved behandling av postverdier i en spesiallaget Word-fil. Feilen kan skade systemminnet på en slik måte at en angriper kan kjøre vilkårlig kode.
...
De mest utsatte systemene er systemer der Microsoft Word brukes, inkludert arbeidsstasjoner og terminalservere. Servere kan være mer utsatt hvis administratorer lar brukerne logge seg på servere og kjøre programmer. Det frarådes imidlertid sterkt at dette tillates.

**Hva gjør oppdateringen?**    
Oppdateringen fjerner sikkerhetsproblemet ved å endre måten Word som initialiserer minne på ved behandling av postverdier på, når Word-filer åpnes.

**Var dette sikkerhetsproblemet offentliggjort da denne sikkerhetsbulletinen ble publisert?**  
Ja. Dette sikkerhetsproblemet var offentliggjort da denne sikkerhetsbulletinen opprinnelig ble publisert. Det er tildelt Common Vulnerability and Exposure-nummer [CVE-2008-2244](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2244). Dette sikkerhetsproblemet ble først beskrevet i [Microsofts sikkerhetsveiledning 953635](microsoft-security-advisory-953635.md).
...
Ja. Denne sikkerhetsoppdateringen tar for seg sikkerhetsproblemet som for øyeblikket utnyttes. Sikkerhetsproblemet som omtales, er tildelt Common Vulnerability and Exposure-nummer [CVE-2008-2244](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2244).
...
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/955048">Microsoft Knowledge Base-artikkel 955048</a></td>
</tr>
<tr class="even">
...
Microsoft [takker](http://go.microsoft.com/fwlink/?linkid=21127) følgende for samarbeidet med å beskytte kundene:
  ...
  - [ISC/SANS](http://isc.sans.org/) for rapporten om sikkerhetsproblemet i Word ved analyse av poster (CVE-2008-2244).
