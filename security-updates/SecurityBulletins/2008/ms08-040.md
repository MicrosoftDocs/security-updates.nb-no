...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=4c9851cc-2c4c-4190-872c-84993a7623b7">SQL Server 2005 med SP2 for Itanium-based Systems</a><br />
(KB948109)</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a60bb7e7-ef4e-4cbd-b63a-0ad7bd1402b3">SQL Server 2005 med SP2 for Itanium-based Systems</a><br />
(KB948108)</td>
<td style="border:1px solid black;">Rettighetsutvidelse</td>
<td style="border:1px solid black;">Viktig</td>
<td style="border:1px solid black;">Ingen</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=4c9851cc-2c4c-4190-872c-84993a7623b7">Microsoft SQL Server 2005 Express Edition med Advanced Services Service Pack 2</a><br />
(KB948109)</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a60bb7e7-ef4e-4cbd-b63a-0ad7bd1402b3">Microsoft SQL Server 2005 Express Edition med Advanced Services Service Pack 2</a><br />
(KB948108)</td>
<td style="border:1px solid black;">Rettighetsutvidelse</td>
<td style="border:1px solid black;">Viktig</td>
<td style="border:1px solid black;">Ingen</td>
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Application Center 2000 Service Pack 2</td>
<td style="border:1px solid black;">Microsoft SQL Server 2000 Desktop Engine (MSDE 2000) Service Pack 3a</td>
</tr>
</tbody>
</table>
...
<table style="border:1px solid black;" class="dataTable">
          ...
          <tr class="thead"><th style="border:1px solid black;"></th><th style="border:1px solid black;"></th><th style="border:1px solid black;"></th><th style="border:1px solid black;"></th><th style="border:1px solid black;"></th></tr>
            ...
            <tr><th colspan="5" style="border:1px solid black;">SQL Server</th></tr>
          
          
            <tr class="alternateRow"><td style="border:1px solid black;">SQL Server 7.0 og MSDE 1.0<br />(KB948113)</td><td style="border:1px solid black;">SQL Server 2000 GDR og MSDE 2000<br />(KB948110)</td><td style="border:1px solid black;">SQL Server 2000 QFE og MSDE 2000<br />(KB948111)</td><td style="border:1px solid black;">SQL Server 2005 GDR<br />(KB948109)</td><td style="border:1px solid black;">SQL Server 2005 QFE<br />(KB948108)</td></tr>
...
## Alvorlighetsgrader og identifikatorer for sikkerhetsproblem
 ...
 <table style="border:1px solid black;" class="dataTable">
          ...
          <tr class="thead"><th style="border:1px solid black;">Berørt programvare</th><th style="border:1px solid black;">Sikkerhetsproblem ved gjenbruk av minnesider – CVE-2008-0085</th><th style="border:1px solid black;">Sikkerhetsproblem med bufferoverløp ved konvertering – CVE-2008-0086</th><th style="border:1px solid black;">Sikkerhetsproblem i SQL Server som kan forårsake minnefeil – CVE-2008-0107</th><th style="border:1px solid black;">Sikkerhetsproblem med bufferoverløp i SQL Server – CVE-2008-0106</th><th style="border:1px solid black;">Samlet alvorlighetsgrad</th></tr>
          
            <tr><th colspan="6" style="border:1px solid black;">SQL Server</th></tr>
          
          
            <tr><td style="border:1px solid black;">SQL Server 7.0 Service Pack 4</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">Ikke relevant</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Rettighetsutvidelse</td><td style="border:1px solid black;">Ikke relevant</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
              </td></tr>
            <tr class="alternateRow"><td style="border:1px solid black;">SQL Server 2000 Service Pack 4</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Rettighetsutvidelse</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Rettighetsutvidelse</td><td style="border:1px solid black;">Ikke relevant</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
              </td></tr>
            <tr><td style="border:1px solid black;">SQL Server 2000 Itanium-based Edition Service Pack 4</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Rettighetsutvidelse</td><td style="border:1px solid black;">
            ...
            <tr class="alternateRow"><td style="border:1px solid black;">SQL Server 2005 Service Pack 1 og SQL Server 2005 Service Pack 2</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">Ikke relevant</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Rettighetsutvidelse</td><td style="border:1px solid black;">
            ...
            <tr><td style="border:1px solid black;">SQL Server 2005 x64 Edition Service Pack 1 og SQL Server 2005 x64 Edition Service Pack 2</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">Ikke relevant</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Rettighetsutvidelse</td><td style="border:1px solid black;">
            ...
            <tr class="alternateRow"><td style="border:1px solid black;">SQL Server 2005 med SP1 for Itanium-based Systems og SQL Server 2005 med SP2 for Itanium-based Systems</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">Ikke relevant</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Rettighetsutvidelse</td><td style="border:1px solid black;">
            ...
            <tr><td style="border:1px solid black;">Microsoft Data Engine (MSDE) 1.0 Service Pack 4</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">Ikke relevant</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Rettighetsutvidelse</td><td style="border:1px solid black;">Ikke relevant</td><td style="border:1px solid black;">
            ...
            <tr class="alternateRow"><td style="border:1px solid black;">Microsoft SQL Server 2000 Desktop Engine (MSDE 2000) Service Pack 4</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Rettighetsutvidelse</td><td style="border:1px solid black;">
            ...
            <tr><td style="border:1px solid black;">Microsoft SQL Server 2005 Express Edition Service Pack 1 og Microsoft SQL Server 2005 Express Edition Service Pack 2</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">Ikke relevant</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Rettighetsutvidelse</td><td style="border:1px solid black;">
            ...
            <tr class="alternateRow"><td style="border:1px solid black;">Microsoft SQL Server 2005 Express Edition med Advanced Services Service Pack 1 og Microsoft SQL Server 2005 Express Edition med Advanced Services Service Pack 2</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">Ikke relevant</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Rettighetsutvidelse</td><td style="border:1px solid black;">
            ...
            <tr><th colspan="6" style="border:1px solid black;">Windows-komponenter</th></tr>
          
          
            <tr><td style="border:1px solid black;">Microsoft SQL Server 2000 Desktop Engine (WMSDE)</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Rettighetsutvidelse</td><td style="border:1px solid black;">
            ...
            <tr class="alternateRow"><td style="border:1px solid black;">Windows Internal Database (WYukon) Service Pack 2</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">Ikke relevant</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Rettighetsutvidelse</td><td style="border:1px solid black;">Ikke relevant</td><td style="border:1px solid black;">
            ...
            <tr><td style="border:1px solid black;">Windows Internal Database (WYukon) x64 Edition Service Pack 2</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Tilgjengeliggjøring av informasjon</td><td style="border:1px solid black;">Ikke relevant</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Rettighetsutvidelse</td><td style="border:1px solid black;">Ikke relevant</td><td style="border:1px solid black;">
...
<tr class="odd">
<td style="border:1px solid black;">SQL Server 2005 x64-based Edition Service Pack 2</td>
<td style="border:1px solid black;">Ja</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008 og Windows Server 2008 for x64-baserte systemer</td>
<td style="border:1px solid black;">Ja</td>
</tr>
</tbody>
</table>
...
<td style="border:1px solid black;">Det er ikke planlagt noen fremtidige oppdateringspakker for SQL Server 7.0</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Manuell installasjon</td>
<td style="border:1px solid black;">Du får oppdateringsfiler for SQL 7.0 i en kjørbar selvutpakkende fil fra Microsoft Download Center-koblingen i tabellen Berørt programvare. Det følger en Viktig-fil med instruksjoner om manuell installasjon med oppdateringsfilene for SQL 7.0.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Du får oppdateringsfiler for SQL 7.0 i en kjørbar selvutpakkende fil fra Microsoft Download Center-koblingen i tabellen Berørt programvare. Du finner instruksjoner om manuell avinstallasjon av oppdateringen i en vedlagt Viktig-fil.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Filinformasjon</strong></td>
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/941203">Microsoft Knowledge Base-artikkel 941203</a></td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Inkludert i fremtidige oppdateringspakker</strong></td>
<td style="border:1px solid black;">Det er ikke planlagt noen fremtidige oppdateringspakker for SQL Server 2000</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Distribusjon</strong></td>
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">For GDR-oppdateringen av SQL Server 2000 installert på alle 32-biters og x64-baserte systemer som støttes:<br />
SQL2000-KB948110-v8.00.2050-x86x64-ENU /quiet /allinstances</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For GDR-oppdateringen av alle Itanium-based-versjoner av SQL Server 2000 som støttes:<br />
SQL2000-KB948110-v8.00.2050-ia64-ENU /quiet /allinstances</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For QFE-oppdateringen av SQL Server 2000 installert på alle 32-biters og x64-baserte systemer som støttes:<br />
SQL2000-KB948111-v8.00.2273-x86x64-ENU /quiet /allinstances</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For QFE-oppdateringen av alle Itanium-based-versjoner av SQL Server 2000 som støttes:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Oppdater loggfil</td>
<td style="border:1px solid black;">SQL2000-KB948110-V8.00.2050-x86-&lt;språk&gt;.log eller SQL2000-KB948111-V8.00.2273-x86-&lt;språk&gt;.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Mer informasjon</td>
<td style="border:1px solid black;">Se avsnittet <strong>Veiledning og verktøy for søking og distribusjon</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informasjon om fjerning</strong></td>
<td style="border:1px solid black;">For alle versjoner av SQL Server 2000 som støttes:<br />
...
<table style="border:1px solid black;" class="dataTable">
                  ...
                  <tr class="thead"><th style="border:1px solid black;">Bryter</th><th style="border:1px solid black;">Beskrivelse</th></tr>
                    ...
                    <tr><td style="border:1px solid black;">
                      ...
                      </td><td style="border:1px solid black;">Installerer oppdateringen på alle forekomster</td></tr>
                    <tr class="alternateRow"><td style="border:1px solid black;">
                        <strong>/InstanceName={forekomst}</strong>
                      </td><td style="border:1px solid black;">Installerer oppdateringen på en angitt forekomst</td></tr>
...
<tr class="odd">
<td style="border:1px solid black;">Installasjon uten brukermedvirkning</td>
<td style="border:1px solid black;">For GDR-oppdateringen av alle 32-biters versjoner av SQL Server 2005 som støttes:<br />
SQLServer2005-KB948109-x86-ENU /quiet /allinstances</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For GDR-oppdateringen av alle x64-baserte versjoner av SQL Server 2005 som støttes:<br />
SQLServer2005-KB948109-x64-ENU /quiet /allinstances</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For GDR-oppdateringen av alle Itanium-based-versjoner av SQL Server 2005 som støttes:<br />
SQLServer2005-KB948109-ia64-ENU /quiet /allinstances</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For QFE-oppdateringen av alle 32-biters versjoner av SQL Server 2005 som støttes:<br />
SQLServer2005-KB948108-x86-ENU /quiet /allinstances</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For QFE-oppdateringen av alle x64-baserte versjoner av SQL Server 2005 som støttes:<br />
SQLServer2005-KB948108-x64-ENU /quiet /allinstances</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For QFE-oppdateringen av alle Itanium-based-versjoner av SQL Server 2005 som støttes:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informasjon om fjerning</strong></td>
<td style="border:1px solid black;">For alle versjoner av SQL Server 2005 som støttes:<br />
Bruke verktøyet <strong>Legg til eller fjern programmer</strong> i Kontrollpanel</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Filinformasjon</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>/rsupgradedatabaseaccount</strong></td>
<td style="border:1px solid black;">Brukerkonto for å oppgradere Reporting Services</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>/rsupgradepassword</strong></td>
<td style="border:1px solid black;">Passord for brukerkonto for å oppgradere Reporting Services</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>/rsupgradedatabase</strong></td>
<td style="border:1px solid black;">Forhindrer at Reporting Services-databasen oppgraderes når parameteren er 0</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>/allinstances</strong></td>
<td style="border:1px solid black;">Installerer oppdateringen på alle forekomster</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>/InstanceName={forekomst}</strong></td>
<td style="border:1px solid black;">Installerer oppdateringen på en angitt forekomst</td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Inkludert i fremtidige oppdateringspakker</strong></td>
<td style="border:1px solid black;">Det er ikke planlagt noen fremtidige oppdateringspakker for SQL Server 2000 Desktop Engine (WMSDE)</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Distribusjon</strong></td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Installasjon uten brukermedvirkning</td>
<td style="border:1px solid black;">For alle 32-biters versjoner av SQL Server 2000 Desktop Engine (WMSDE) som støttes:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Installasjon uten brukermedvirkning</td>
<td style="border:1px solid black;">For all 32-biters versjoner av Windows Internal Database (WYukon) som støttes:<br />
WYukon2005Setup-KB948109-x86-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For all 64-biters versjoner av Windows Internal Database (WYukon) som støttes:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informasjon om fjerning</strong></td>
<td style="border:1px solid black;">For alle versjoner av Windows Internal Database (WYukon) som støttes:<br />
Bruke verktøyet <strong>Legg til eller fjern programmer</strong> i Kontrollpanel.
