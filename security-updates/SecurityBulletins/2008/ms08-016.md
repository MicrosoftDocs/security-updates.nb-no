...
<tr class="even">
<td style="border:1px solid black;">Microsoft PowerPoint Viewer 2003</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Visio 2002 Service Pack 2</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Visio 2003 Viewer</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Project 2000 Service Pack 1</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Project 2002 Service Pack 2</td>
</tr>
<tr class="odd">
...
<th style="border:1px solid black;">Sikkerhetsproblem ved celleanalysering i Microsoft Office som kan føre til minnefeil – CVE-2008-0113</th>
<th style="border:1px solid black;">Sikkerhetsproblem i Microsoft Office som kan føre til minnefeil – CVE-2008-0118</th>
<th style="border:1px solid black;">Samlet alvorlighetsgrad</th>
</tr>
</thead>
<tbody>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Office Excel Viewer 2003 og Microsoft Office Excel Viewer Service Pack 3</td>
<td style="border:1px solid black;"><strong>Viktig</strong> <br />
Ekstern kjøring av kode</td>
<td style="border:1px solid black;">Ingen</td>
<td style="border:1px solid black;"><strong>Viktig</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office Word Viewer 2003 og Microsoft Office Word Viewer Service Pack 3</td>
<td style="border:1px solid black;"><strong>Viktig</strong> <br />
Ekstern kjøring av kode</td>
<td style="border:1px solid black;">Ingen</td>
<td style="border:1px solid black;"><strong>Viktig</strong></td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Office Excel Viewer og Microsoft Office Excel Viewer 2003 Service Pack 3</td>
<td style="border:1px solid black;">Ja</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office Word Viewer og Microsoft Office Word Viewer 2003 Service Pack 3</td>
<td style="border:1px solid black;">Ja</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Office 2004 for Mac</td>
...
<td style="border:1px solid black;">Hvis du vil ha mer informasjon om oppdaging og distribusjon, kan du se delen <strong>Microsofts veiledning og verktøy for søking og distribusjon</strong> tidligere i denne bulletinen.<br />
<br />
...
<td style="border:1px solid black;">Se overskriften Filinformasjon nedenfor hvis du vil se hele filmanifestet.</td>
</tr>
<tr class="even">
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Mso9.dll</td>
<td style="border:1px solid black;">9.0.0.8968</td>
<td style="border:1px solid black;">5. februar 2008</td>
<td style="border:1px solid black;">04:01</td>
<td style="border:1px solid black;">5 595 185</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">MSPUB, O9PUB, 09PB</td>
<td style="border:1px solid black;">ProductFiles,PubPrimary,MSDrawFiles</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">O9EXL</td>
<td style="border:1px solid black;">ProductFiles, EXCELNonBootFiles</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">O9PRM</td>
<td style="border:1px solid black;">ProductFiles, OUTLOOKNonBootFiles, WORDNonBootFiles, ACCESSNonBootFiles, EXCELNonBootFiles, FPClientNonBootFiles, PPTNonBootFiles, ProductNonBootFiles</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">O9PRO</td>
<td style="border:1px solid black;">ProductFiles, OUTLOOKNonBootFiles, WORDNonBootFiles, ACCESSNonBootFiles, EXCELNonBootFiles, PPTNonBootFiles</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">O9SBE, 9327_o9procd1_sbe_coxs_slv_data1 product</td>
<td style="border:1px solid black;">ProductFiles, OUTLOOKNonBootFiles,WORDNonBootFiles, EXCELNonBootFiles</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">O9FP</td>
<td style="border:1px solid black;">ProductFiles, FPClientNonBootFiles, ProductNonBootFiles</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">O9PIPC1</td>
<td style="border:1px solid black;">ProductFiles, OUTLOOKNonBootFiles, MSDrawFiles, WORDNonBootFiles, EXCELNonBootFiles</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">O9PIPC2</td>
<td style="border:1px solid black;">ProductFiles, MSDrawFiles, WORDNonBootFiles, EXCELNonBootFiles</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">O9PRMCD2</td>
<td style="border:1px solid black;">ProductFiles,AccessRuntimeMaster, PubPrimary, MSDrawFiles, SBCMNonBootFiles</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">O9STD</td>
<td style="border:1px solid black;">ProductFiles, OUTLOOKNonBootFiles, WORDNonBootFiles, EXCELNonBootFiles, PPTNonBootFiles</td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informasjon om fjerning</strong></td>
<td style="border:1px solid black;">Bruke verktøyet Legg til / fjern programmer i Kontrollpanel.<br />
<br />
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Ietag.dll</td>
<td style="border:1px solid black;">10.0.6731</td>
<td style="border:1px solid black;">10. september 2004</td>
<td style="border:1px solid black;">21:11</td>
<td style="border:1px solid black;">105 152</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Mso.dll</td>
<td style="border:1px solid black;">10.0.6839.0</td>
<td style="border:1px solid black;">30. oktober 2007</td>
<td style="border:1px solid black;">18:08</td>
<td style="border:1px solid black;">9 819 136</td>
</tr>
</tbody>
</table>
...
<td style="border:1px solid black;">21:09</td>
<td style="border:1px solid black;">167 256</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Mso.dll</td>
<td style="border:1px solid black;">11.0.8202.0</td>
<td style="border:1px solid black;">20. november 2007</td>
<td style="border:1px solid black;">04:03</td>
<td style="border:1px solid black;">12 259 328</td>
</tr>
</tbody>
</table>
