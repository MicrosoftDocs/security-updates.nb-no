...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=5dfb7998-0316-40e5-9fc5-7a1afc18e15e">SQL Server 2005 med SP2 for Itanium-based Systems</a><br />
(KB960089)</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=aa2b82ca-e94e-4491-8639-f0749b1a0f3a">SQL Server 2005 med SP2 for Itanium-based Systems</a><br />
(KB960090)</td>
<td style="border:1px solid black;">Ekstern kjøring av kode</td>
<td style="border:1px solid black;">Viktig</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=125468">MS08-052</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=5dfb7998-0316-40e5-9fc5-7a1afc18e15e">SQL Server 2005 Express Edition med Advanced Services Service Pack 2</a><br />
(KB960089)</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=aa2b82ca-e94e-4491-8639-f0749b1a0f3a">SQL Server 2005 Express Edition med Advanced Services Service Pack 2</a><br />
(KB960090)</td>
<td style="border:1px solid black;">Ekstern kjøring av kode</td>
<td style="border:1px solid black;">Viktig</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=125468">MS08-052</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">SQL Server 2005 x64 Edition Service Pack 3</td>
<td style="border:1px solid black;">Ikke relevant</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">SQL Server 2005 med SP3 for Itanium-based Systems</td>
<td style="border:1px solid black;">Ikke relevant</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">SQL Server 2008 (32-biters versjoner)</td>
<td style="border:1px solid black;">Ikke relevant</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">SQL Server 2008 (x64-baserte versjoner)</td>
<td style="border:1px solid black;">Ikke relevant</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">SQL Server 2008 (Itanium-based-versjoner)</td>
<td style="border:1px solid black;">Ikke relevant</td>
</tr>
</tbody>
</table>
...
<table style="border:1px solid black;" class="dataTable">
          ...
          <tr class="thead"><th style="border:1px solid black;"></th><th style="border:1px solid black;"></th><th style="border:1px solid black;"></th><th style="border:1px solid black;"></th></tr>
            ...
            <tr><th colspan="4" style="border:1px solid black;">SQL Server</th></tr>
          
          
            <tr class="alternateRow"><td style="border:1px solid black;">SQL Server 2000 GDR og MSDE 2000<br />(KB960082)</td><td style="border:1px solid black;">SQL Server 2000 QFE og MSDE 2000<br />(KB960083)</td><td style="border:1px solid black;">SQL Server 2005 GDR<br />(KB960089)</td><td style="border:1px solid black;">SQL Server 2005 QFE<br />(KB960090)</td></tr>
...
<table style="border:1px solid black;" class="dataTable">
          ...
          <tr class="thead"><th style="border:1px solid black;">Berørt programvare</th><th style="border:1px solid black;">Sikkerhetsproblem med begrenset minneoverskriving for sp_replwritetovarbin i SQL Server – CVE-2008-5416</th><th style="border:1px solid black;">Samlet alvorlighetsgrad</th></tr>
          
            <tr><th colspan="3" style="border:1px solid black;">SQL Server</th></tr>
          
          
            <tr><td style="border:1px solid black;">SQL Server 2000 Service Pack 4</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Ekstern kjøring av kode</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
              </td></tr>
            <tr class="alternateRow"><td style="border:1px solid black;">SQL Server 2000 Itanium-based Edition Service Pack 4</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Ekstern kjøring av kode</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
              </td></tr>
            <tr><td style="border:1px solid black;">SQL Server 2005 Service Pack 2</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Ekstern kjøring av kode</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
              </td></tr>
            <tr class="alternateRow"><td style="border:1px solid black;">SQL Server 2005 x64 Edition Service Pack 2</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Ekstern kjøring av kode</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
              </td></tr>
            <tr><td style="border:1px solid black;">SQL Server 2005 med SP2 for Itanium-based Systems</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Ekstern kjøring av kode</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
              </td></tr>
            ...
            <tr><td style="border:1px solid black;">SQL Server 2005 Express Edition Service Pack 2</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Ekstern kjøring av kode</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
              </td></tr>
            <tr class="alternateRow"><td style="border:1px solid black;">SQL Server 2005 Express Edition med Advanced Services Service Pack 2</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
                <br />Ekstern kjøring av kode</td><td style="border:1px solid black;">
                <strong>Viktig</strong>
              </td></tr>
            ...
            <tr><th colspan="3" style="border:1px solid black;">Windows-komponenter</th></tr>
...
<tr class="odd">
<td style="border:1px solid black;">SQL Server 2005 Express Edition Service Pack 2</td>
<td style="border:1px solid black;">Ja</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">SQL Server 2005 Express Edition med Advanced Services Service Pack 2</td>
<td style="border:1px solid black;">Ja</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 Service Pack 1 og Windows Server 2003 Service Pack 2</td>
...
<td style="border:1px solid black;">SQL2000-KB960082-v8.00.2055-x86-&lt;språk&gt;.log eller SQL2000-KB960083-v8.00.2282-x86-&lt;språk&gt;.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Spesielle instruksjoner</td>
<td style="border:1px solid black;">Oppdateringen tilbys også til forekomster av SQL Server 2000 i klynger. Oppdateringer for SQL Server 2000-klynger krever brukermedvirkning.<br />
<br />
...
<td style="border:1px solid black;">Se <a href="http://support.microsoft.com/kb/959420">Microsoft Knowledge Base-artikkel 959420</a></td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td style="border:1px solid black;">Spesielle instruksjoner</td>
<td style="border:1px solid black;">Oppdateringen tilbys også til forekomster av SQL Server 2005 i klynger. Oppdateringer for SQL Server 2005-klynger krever brukermedvirkning.<br />
<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Inkludert i fremtidige oppdateringspakker</strong></td>
<td style="border:1px solid black;">Det er ikke planlagt noen fremtidige oppdateringspakker for Microsoft SQL Server 2000 Desktop Engine (WMSDE)</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Distribusjon</strong></td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Installasjon uten brukermedvirkning</td>
<td style="border:1px solid black;">For alle 32-biters versjoner av Microsoft SQL Server 2000 Desktop Engine (WMSDE) som støttes:<br />
